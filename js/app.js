(() => {
    ...
    function initSliders() {
        if (document.querySelector(".swiper")) {
            new swiper_core_Swiper(".featured__slider", {
                modules: [ Navigation ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            const thumbSlider = new swiper_core_Swiper(".thumb-slider__slider", {
                centeredSlides: true,
                slidesPerView: "3",
                watchSlidesProgress: true,
                speed: 800,
            ...
            new swiper_core_Swiper(".reviews__slider", {
                modules: [ Pagination, Keyboard, Thumb ],
                speed: 800,
                loop: true,
                spaceBetween: 0,
                slidesPerView: 1,
    ...
    searchButton.addEventListener("click", (() => {
        searchForm.classList.contains("_open") ? searchForm.classList.remove("_open") : searchForm.classList.add("_open");
    }));
    document.addEventListener("click", (event => {
        if (!event.target.closest(".header__form") && !event.target.classList.contains("actions-header__search")) searchForm.classList.remove("_open");
    }));
    menuInit();
    spollers();
    showMore();
